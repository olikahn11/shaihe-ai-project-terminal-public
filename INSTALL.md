...
请从 [GitHub Release v4.4.1](https://github.com/olikahn11/shaihe-ai-project-terminal-public/releases/tag/v4.4.1) 下载对应平台的文件。下载后建议先按照本文的校验步骤验证 SHA-256。
...
把 [SHA256SUMS.txt](https://github.com/olikahn11/shaihe-ai-project-terminal-public/releases/download/v4.4.1/SHA256SUMS.txt) 下载到安装包所在目录，在终端执行：
